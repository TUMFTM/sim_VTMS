...
Parameter.UA_Batteriepack_Fluid_Table = ([25;45]*3.5*10);           % Heat transfer capacity of the electric machine to the coolant subject to the volume flow inside the coolant cycles in W/K
