...
Parameter.UA_Batteriepack_Fluid_Table = ([15;30]*10);               % Heat transfer capacity of the electric machine to the coolant subject to the volume flow inside the coolant cycles in W/K
