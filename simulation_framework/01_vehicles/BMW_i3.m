...
Parameter.name  =  'BMWi3';                                         % Vehicle name
...
Parameter.i_Getriebe = 9.665;                                       % total transmission ratio between electric machine and wheels
...
Parameter.n_MOSFET = 148;                                           % number of MOSFETS in power electronics. This is a model assumption to get the heat dissipation right and comparable between the different vehicles.
...
Parameter.p_Zelle = 42;                                             % Number of cells connected in parallel inside the battery system
...
Parameter.UA_EMaschine_Umgebung_Table = ([0.03;228.19]*1.38);       % Heat transfer capacity of the electric machine to the ambient temperature subject to the vehicle speed in W/K
Parameter.UA_Getriebe_Umgebung_Table = ([1.6;305.7]*1.38);          % Heat transfer capacity of the transmission to the ambient temperature subject to the vehicle speed in W/K
Parameter.UA_EMaschine_Fluid_Table = ([7.5;15]*1.37);               % Heat transfer capacity of the electric machine to the coolant subject to the volume flow inside the coolant cycles in W/K


% UA power electronics

Parameter.UA_c_Umgebung_Table = ([11.5;12.8]*1.38);                 % Heat transfer capacity of the power electronics to the ambient temperature subject to the vehicle speed in W/K in W/K
Parameter.UA_c_Fluid_Table = ([4.25;8.5]*1.37);                     % Heat transfer capacity of the power electronics to the coolant subject to the volume flow inside the coolant cycles in W/K


% UA battery system

Parameter.UA_Batteriepack_Umgebung_Table = ([1;270]*2);             % Heat transfer capacity of the battery system to the ambient temperature subject to the vehicle speed in W/K
Parameter.UA_Batteriepack_Fluid_Table = ([15;30]*2*10);             % Heat transfer capacity of the electric machine to the coolant subject to the volume flow inside the coolant cycles in W/K
