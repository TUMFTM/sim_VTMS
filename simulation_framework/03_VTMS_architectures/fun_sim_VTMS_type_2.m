function [OutputData] = fun_sim_VTMS_type_2(vehicle, load_cycle, charging_info, P_charge_in, Fluid, T_ambient_in, T_init_in, VTMS_name)
...
Konfig_Kuehlkreislauf{1}={{'Fluid_Batteriepack(1)','Fluid_Schlauch(1)','Fluid_Ladegeraet(1)','Fluid_Schlauch(2)','Fluid_Leistungselektronik(1)','Fluid_Schlauch(3)','Fluid_EMaschine(1)','Fluid_Schlauch(4)','Fluid_Kuehler(1)','Fluid_Schlauch(5)'} % Hier müssen die festgelegten Fluid_Komponenten (aus "Definition der Fluid_Komponenten") genannt werden, die in dem jeweiligen Kühlkreislauf vorhanden sind (Angabe Nr_Kuehlkreislauf in der jeweiligen Fluid_Komponente muss mit dem Index von Konfig_Kuehlkreislauf übereinstimmen!) -> Eintrag i in dieser Zeile = Nummer i in den unteren beiden Zeilen  
