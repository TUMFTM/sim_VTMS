function [OutputData] = fun_sim_VTMS_type_4(vehicle, load_cycle, charging_info, P_charge_in, Fluid, T_ambient_in, T_init_in, VTMS_name)
...
Fluid_Schlauch(5).Nr_Kuehlkreislauf=2;                                      % Nummer des Kühlkreislaufs, zu dem das Strömungsgebiet des Schlauchs gehört
...
Konfig_Kuehlkreislauf{2}={{'Fluid_Batteriepack(1)','Fluid_Schlauch(5)','Fluid_Schlauch(6)','Fluid_Schlauch(7)','Fluid_PCM(1)','Fluid_Schlauch(8)','Fluid_Schlauch(9)','Fluid_Kuehler(2)','Fluid_Schlauch(10)'} % Hier müssen die festgelegten Fluid_Komponenten (aus "Definition der Fluid_Komponenten") genannt werden, die in dem jeweiligen Kühlkreislauf vorhanden sind (Angabe Nr_Kuehlkreislauf in der jeweiligen Fluid_Komponente muss mit dem Index von Konfig_Kuehlkreislauf übereinstimmen!) -> Eintrag i in dieser Zeile = Nummer i in den unteren beiden Zeilen 
...
Ventil(1).Ventil_nach='Fluid_Schlauch(5)';                                  % Name von Fluid_Komponente innerhalb des entsprechenden Kühlkreislaufs, nach der sich das Dreiwegeventil befindet bzw. nach der die Aufzweigung stattfindet 
Ventil(1).Vereinigung_vor='Fluid_Schlauch(7)';                              % Name von Fluid_Komponente innerhalb des entsprechenden Kühlkreislaufs, vor der die Vereinigung der zwei nach der Aufzweigung durch das Dreiwegeventil resultierenden Pfade stattfindet
...
% UA_Waermetauscher_Kuehlfluessigkeit_Table{1}=vehicle.UA_Waermetauscher_Fluid_Table;                   % Die Wärmeübertragungsfähigkeit des Wärmetauschers bzgl. der gesamten Kühlflüssigkeit im 1. bzw. 2. Strömungsgebiet des Wärmetauschers in Abh. von den Volumenströmen der zwei Kühlflüssigkeiten in W/K
