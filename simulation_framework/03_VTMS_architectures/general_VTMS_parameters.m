...
if sim_VTMS_type_1
    Fluid_data{1}.PV_Kuehlkreislauf_Break_T = [273.15+25;273.15+35];                % Control of volume flow, Breakpoints: Temperatures in K
    Fluid_data{1}.PV_Kuehlkreislauf_Table = [200/(3.6*10^6);2000/(3.6*10^6)];       % Control of volume flow, Table data: Volume flow in m^3/s. Linear interpolation between the breakpoints, clipping of last value outside of breakpoints.
...
if sim_VTMS_type_2
    Fluid_data{2}.PV_Kuehlkreislauf_Break_T = [273.15+25;273.15+35];
    Fluid_data{2}.PV_Kuehlkreislauf_Table = [200/(3.6*10^6);2000/(3.6*10^6)];
...
if sim_VTMS_type_3
    Fluid_data{3}.PV_Kuehlkreislauf_Break_T = [273.15+25;273.15+35];
    Fluid_data{3}.PV_Kuehlkreislauf_Table = [200/(3.6*10^6);2000/(3.6*10^6)];
...
if sim_VTMS_type_4
    Fluid_data{4}.PV_Kuehlkreislauf_Break_T = [273.15+25;273.15+35];
    Fluid_data{4}.PV_Kuehlkreislauf_Table = [200/(3.6*10^6);2000/(3.6*10^6)];
...
if sim_VTMS_type_5
    Fluid_data{5}.PV_Kuehlkreislauf_Break_T = [273.15+25;273.15+35];
    Fluid_data{5}.PV_Kuehlkreislauf_Table = [200/(3.6*10^6);2000/(3.6*10^6)];
...
if sim_VTMS_type_6
    Fluid_data{6}.PV_Kuehlkreislauf_Break_T = [273.15+25;273.15+35];
    Fluid_data{6}.PV_Kuehlkreislauf_Table = [200/(3.6*10^6);2000/(3.6*10^6)];
...
if sim_VTMS_type_7
    Fluid_data{7}.PV_Kuehlkreislauf_Break_T = [273.15+25;273.15+35];
    Fluid_data{7}.PV_Kuehlkreislauf_Table = [200/(3.6*10^6);2000/(3.6*10^6)];
